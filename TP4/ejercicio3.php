...
<head>
    ...
    <script src="scriptValiadaFormulario.js"></script>
</head>
<body>
    <div class="container">
        <form action="presentacion3.php" novalidate class="row g-3 needs-validation" id="form4" method="post" enctype="multipart/form-data">
            <div class="col-6">
