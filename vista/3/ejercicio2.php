...
<head>
    ...
    <title>Formulario 2 subir .txt</title>
    ...
    <script src="../../control/3/validarArchivo2.js"></script>
</head>
<body>
    <div class="container">
        <form action="../../modelo/3/upload2.php" method="post" class="needs-validation" novalidate id="form-subir2" name="form-subir2" enctype="multipart/form-data">
